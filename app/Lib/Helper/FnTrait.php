...
trait FnTrait
{
	...
	private function validPassword($pw='')
	{
		...
		if(preg_match_all($r1,$pw, $o)<1) $valid_= false;
		if(preg_match_all($r2,$pw, $o)<1) $valid_= false;
		if(preg_match_all($r3,$pw, $o)<1) $valid_= false;
		if(preg_match_all($r4,$pw, $o)<1) $valid_= false;
		if(strlen($pw)<8) $valid_= false;
