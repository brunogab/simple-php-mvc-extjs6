...
<html>
	...
	<body>
		...
		<div class="loadlogo" id="center" style="background: linear-gradient(rgba(245,245,245,0.6), rgba(245,245,245,0.6)), url(<?php echo $config['logo.loading'] ?>) center center no-repeat">
			<div class="loader">
		...
		<link rel="stylesheet" type="text/css" href="<?php echo $config['path.extjs'] ?>/build/classic/theme-neptune/resources/theme-neptune-all.css" />
		<script type="text/javascript" src="<?php echo $config['path.extjs'] ?>/build/ext-all.js"></script>
