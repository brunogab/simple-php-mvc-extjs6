				...
				items: [{
					...
					menu: {
						...
						items: [{
							...
							iconCls: 'icon-pdf',
							handler: function(){
								Ext.MessageBox.prompt('Enter', 'type some text:', function(btn, text){
									if (btn=='ok'){
										if (text == ''){
											Ext.MessageBox.show({title: Ext.String.format('{0}', 'text_error'),msg: Ext.String.format('{0}', 'it was empty!'),buttons: Ext.Msg.OK,icon: Ext.MessageBox.ERROR});
										}else{
